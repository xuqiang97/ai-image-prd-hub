...
归属需求：[M-37095【AI生图】\[运营\]店铺ASIN多套商品资料择优取数逻辑优化](../README.md)
...
接口返回一套或多套资料时，均按父级 [M-37095 README](../README.md) 的正式规则处理：
...
| 类型 | 地址或名称 | 本文用途 |
|---|---|---|
| 父级正式 PRD | [M-37095 README](../README.md) | 多套资料择优正式规则、范围和验收来源 |
